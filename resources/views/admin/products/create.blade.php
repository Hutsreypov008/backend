...
<div class="prod-header">
    <div class="prod-header-content">
        <div class="prod-header-left">
            <h1><i class="bi bi-plus-circle-fill"></i>Create Product</h1>
        ...
        <form action="{{ route('admin.products.store') }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="prod-form-row single">
                <div class="prod-form-group">
                    ...
                    <textarea id="description" name="description" class="prod-input" rows="4"
                              placeholder="Describe your product's features, specifications, and details...">{{ old('description') }}</textarea>
            ...
            <div class="prod-form-row single">
                <div class="prod-form-group">
                    ...
                    <div class="prod-hint"><i class="bi bi-info-circle"></i>JPG, PNG, or WebP. Max 2MB. Optional.</div>
                </div>
            </div>
